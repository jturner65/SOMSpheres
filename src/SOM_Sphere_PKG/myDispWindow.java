...
public abstract class myDispWindow {
	...
	public static final float xOff = 20 , yOff = 20.0f * (SOM_SphereMain.txtSz/12.0f), btnLblYOff = 2 * yOff, rowStYOff = yOff*.15f;
	...
	public static final int[] editCrcFillClrs = new int[] {SOM_SphereMain.gui_FaintMagenta, SOM_SphereMain.gui_FaintGreen};			
	...
	public myDispWindow(SOM_SphereMain _p, String _n, int _flagIdx, int[] fc,  int[] sc, float[] rd, float[] rdClosed, String _winTxt, boolean _canDrawTraj) {
		...
		winText = _winTxt;
		trajFillClrCnst = SOM_SphereMain.gui_Black;		//override this in the ctor of the instancing window class
		trajStrkClrCnst = SOM_SphereMain.gui_Black;
...
//	public static final String[] guiBtnSetValsNames = new String[]{"Set Vals at Cur Time","Set Vals Globally"};
	...
	public final String[][] guiBtnNames = new String[][]{
		new String[]{"Anim Result", "SOM Map UI"},							//display specific windows - multi-select/ always on if sel
	...
	public mySideBarMenu(SOM_SphereMain _p, String _n, int _flagIdx, int[] fc, int[] sc, float[] rd, float[] rdClosed, String _winTxt, boolean _canDrawTraj) {
		super(_p, _n, _flagIdx, fc, sc,  rd, rdClosed, _winTxt, _canDrawTraj);
		guiBtnStFillClr = new int[]{		//button colors based on state
				SOM_SphereMain.gui_White,								//disabled color for buttons
				SOM_SphereMain.gui_LightGray,								//not clicked button color
				SOM_SphereMain.gui_LightBlue,									//clicked button color
			};
		guiBtnStTxtClr = new int[]{			//text color for buttons
				SOM_SphereMain.gui_LightGray,									//disabled color for buttons
...
class myDrawnSmplTraj {
	...
	public myDrawnSmplTraj(SOM_SphereMain _p, myDispWindow _win,float _topOffy, int _fillClrCnst, int _strkClrCnst, boolean _flat, boolean _smCntl){
		pa = _p;
...
class myScrollBars{
	...
	public myScrollBars(SOM_SphereMain _pa,myDispWindow _win){
		pa = _pa;
		win = _win;
		ID = scrBarCnt++;
		setSize();
