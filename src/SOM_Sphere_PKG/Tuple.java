...
public class Tuple<X,Y> implements Comparable<Tuple<X,Y>> { 
    public final X x;    public final Y y;  private final Float sqmag;
    public Tuple(X x, Y y) {    this.x = x;   this.y = y; sqmag = getSqMag();  }
...
class Triple<X,Y,Z> implements Comparable<Triple<X,Y,Z>> { 
	...
	public Float getSqMag(){if((x != null) && (y != null) && (z!= null)) { return 1.0f*((x.hashCode()*x.hashCode()) + (y.hashCode()*y.hashCode()) + (z.hashCode()*z.hashCode()));} else {return null;}}
	@Override
