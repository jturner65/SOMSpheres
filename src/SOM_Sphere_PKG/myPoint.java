...
//
////comparable point to use in sorted datastructures
//public class myLocation extends myPointf implements Comparable<myLocation>  {
//
//	public myLocation() {super();}
//	public myLocation(float _x, float _y, float _z) {	super(_x, _y, _z);}
//	public myLocation(double _x, double _y, double _z) {	super(_x, _y, _z);}
//	public myLocation(myPointf p) {		super(p);}
//	public myLocation(myPointf A, myVectorf B) {		super(A, B);}
//	public myLocation(myPointf A, float s, myPointf B) {		super(A, s, B);}
//	public int hashCode() {return 97 * (97 * (97 +  ((Float)x).hashCode()) + ((Float)y).hashCode()) + ((Float)z).hashCode(); }
//	@Override
//	public int compareTo(myLocation arg0) {
