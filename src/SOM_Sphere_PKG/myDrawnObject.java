...
public abstract class myDrawnObject {
	...
	public myDrawnObject(SOM_SphereMain _pa, myVector _canvNorm) {
		pa = _pa;
...
class myVariStroke extends myDrawnObject {
	...
	public myVariStroke(SOM_SphereMain _pa, myVector _canvNorm, int fillClrCnst, int strkClrCnst) {
		super(_pa, _canvNorm);
...
class cntlPt extends myPoint {
	...
	public cntlPt(SOM_SphereMain _pa, myPoint _p, float _r, float _w){ super(_p.x,_p.y, _p.z); pa=_pa; ID=IDincr++;r=_r; w=_w; }
	public cntlPt(SOM_SphereMain _pa, myPoint _p, float _w){this(_pa, _p, baseRad, _w);}
	public cntlPt(SOM_SphereMain _pa, myPoint _p){this(_pa, _p, baseRad, baseRad);}
	public cntlPt(SOM_SphereMain _pa){this(_pa, _pa.P(),1);}
...
abstract class myOffset {
	...
	public myOffset(SOM_SphereMain _pa, boolean _ec){
		pa = _pa;
		ID = IDcnt++;
		endCaps = _ec;
	}	
	
	public myOffset(SOM_SphereMain _pa){this(_pa, true);}
...
class myNormOffset extends myOffset{
	myNormOffset(SOM_SphereMain _pa){super(_pa); name = "Normal offset";}
